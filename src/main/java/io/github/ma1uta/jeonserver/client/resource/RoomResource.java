...
import io.github.ma1uta.jeonserver.event.CreateAliasEvent;
...
public class RoomResource implements RoomApi {
    ...
    public void createAlias(
        ...
        eventBus.publish("createAlias", new CreateAliasEvent(roomId, securityContext, asyncResponse, roomAlias));
    }
