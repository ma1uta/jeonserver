...
public class RoomState implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "pk_sequence_room_state", sequenceName = "room_state_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pk_sequence_room_state")
    private Long id;
