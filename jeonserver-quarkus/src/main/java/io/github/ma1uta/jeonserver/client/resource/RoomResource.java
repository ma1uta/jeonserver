...
import io.github.ma1uta.jeonserver.ServiceExecutor;
import io.github.ma1uta.jeonserver.service.RoomService;
...
public class RoomResource implements RoomApi {
    ...
    public void create(
        ...
        serviceExecutor.execute(() -> roomService.createRoom(createRoomRequest), asyncResponse, uriInfo);
    }
